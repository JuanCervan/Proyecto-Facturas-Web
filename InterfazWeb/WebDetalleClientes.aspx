...
&nbsp;<asp:TextBox ID="txbNombre" runat="server" Width="212px" MaxLength="50"></asp:TextBox>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txbNombre" ErrorMessage="El nombre no puede estar vacio" ForeColor="Red" Display="Dynamic" CssClass="alert-danger"></asp:RequiredFieldValidator>
        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txbNombre" ErrorMessage="Ya existe un cliente con ese nombre" ForeColor="Red" OnServerValidate="CustomValidator1_ServerValidate" CssClass="alert-danger"></asp:CustomValidator>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txbNif" ErrorMessage="El NIF no puede estar vacio" ForeColor="Red" Display="Dynamic" CssClass="alert-danger"></asp:RequiredFieldValidator>
        ...
        <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txbNif" ErrorMessage="Ya existe un cliente con ese NIF" ForeColor="Red" OnServerValidate="CustomValidator2_ServerValidate" CssClass="alert-danger"></asp:CustomValidator>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label3" runat="server" Text="Dirección:"></asp:Label>
&nbsp;<asp:TextBox ID="txbDireccion" runat="server" Width="295px" MaxLength="50"></asp:TextBox>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label4" runat="server" Text="Ciudad:"></asp:Label>
&nbsp;<asp:TextBox ID="txbCiudad" runat="server" Width="229px" MaxLength="30"></asp:TextBox>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txbTelefono" ErrorMessage="El télefono debe comenzar por 8 ó 9 y tener 9 cifras" ForeColor="Red" MaximumValue="999999999" MinimumValue="800000000" CssClass="alert-danger"></asp:RangeValidator>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label6" runat="server" Text="Email:"></asp:Label>
&nbsp;<asp:TextBox ID="txbEmail" runat="server" Width="221px" MaxLength="30"></asp:TextBox>
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txbEmail" ErrorMessage="El formato de Email no es correcto" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" CssClass="alert-danger"></asp:RegularExpressionValidator>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label7" runat="server" Text="Persona de contacto:"></asp:Label>
&nbsp;<asp:TextBox ID="txbContacto" runat="server" Width="226px" MaxLength="30"></asp:TextBox>
        &nbsp;
