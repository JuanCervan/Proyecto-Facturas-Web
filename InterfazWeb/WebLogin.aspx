            ...
            <table class="auto-style3">
                ...
                <tr>
                    ...
                    <td class="auto-style7">
                        ...
                        &nbsp;&nbsp;
                        <asp:TextBox ID="txbContrasenya" runat="server" TextMode="Password" MaxLength="5"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        ...
                        &nbsp;
                        <asp:Button ID="btnRegistro" runat="server" CausesValidation="False" OnClick="Button2_Click" Text="Registro" Width="70px" CssClass="btn-secondary" />
&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<asp:Label ID="Label7" runat="server" Font-Size="Small" ForeColor="#0033CC" Text="© J2C 2019"></asp:Label>
                        &nbsp; </td>
                    <td>
                        <br />
                        <br />
